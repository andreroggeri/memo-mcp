...
| `memo.access_token`       | Access token for the backend Memo API    | `""`                            |
| `memo.existingSecretName` | Existing Secret name for token           | `""`                            |
| `memo.existingSecretKey`  | Secret key containing token              | `"memo-access-token"`           |
